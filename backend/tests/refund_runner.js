...
async function runTests() {
    ...
    try {
        ...
        console.error(`Connection to server failed. Is backend server running on port ${PORT}?`, err.message);
        process.exit(1);
    }
    ...
    // D. Over-Refund attempt: ₹35 (remaining is ₹29)
    ...
    const part3Res = await fetch(`${API_URL}/billing/refund`, {
        ...
        body: JSON.stringify({
            ...
            reason_notes: 'Detailed notes explaining other reasons'
        })
    });
    ...
    // Check profile to verify wallet balance increased by ₹100
    ...
    // Check profile to verify wallet balance decreased by ₹50
